...
namespace LeaRun.Utilities
{
    ...
    public class CommonHelper
    {
        ...
        /// <returns></returns>
        public static string DataTimeChange(string data)
        {
            string data1 = "";
            string data2 = "";
            string data3 = "";
            ...
            if (data.Contains("/"))
            {
                ...
                return DisplayDataTime(data1, data2, data3, str);
            }
        ...
        private static string DisplayDataTime(string data1, string data2, string data3, string[] str)
        {
            data1 = str[0].ToString();
            if (data1.Length != 4)
            {
                return "";
            }
            else
            {
                ...
                else
                {
                    ...
                    data3 = str[2].ToString();
                    if (data3.Length != 2 || data3.Length != 1)
                    {
                        return "";
                    }
                    else
